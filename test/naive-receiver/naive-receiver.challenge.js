...
describe("[Challenge] Naive receiver", function () {
    ...
    it("Execution", async function () {
        ...
        // Emptying the receiver in a single transaction using a custom contract
        const EmptyReceiverFactory = await ethers.getContractFactory("EmptyReceiver", deployer);
        emptyReceiver = await EmptyReceiverFactory.deploy(receiver.address, pool.address);

        await emptyReceiver.empty();
    });
